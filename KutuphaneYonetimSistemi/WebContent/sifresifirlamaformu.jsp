...
<table style="width:897px; background:#FFFFFF; margin:0 auto;">
	...
	<td width="600" valign="top" style="border-right:#666666 1px dotted;">
    	...
    	<div id="uye"><h1>Sıfırlama Sayfası:</h1><br>
		   
		   		<form action="sifresifirla.jsp" method="post">
		...
		<table>
			...
			<tr>
				<td><input type="text" name="KullaniciAdi" size="25" value ="Ad"></td>
			</tr>
				<tr>
				<td><input type="text" name="Sifre" size="25" value ="Sifre"></td>
			</tr>
						
		</table>
		<br>
		<input type="submit" value ="SifreSifirla">
	</form>
		 </div>
	</td>
