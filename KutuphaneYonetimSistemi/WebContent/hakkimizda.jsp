...
<title>Hakkımızda - HALK KÜTÜPHANESİ, Mozambik</title>
...
<%
	...
	if(onemliSayfa.getAttribute("sifre")!= "gecerli")
		out.println("<A href='index.html'><IMG SRC='images/home1.gif'></IMG></A><br><br>");
	else
		out.println("<A href='uyeislemsec.html'><IMG SRC='images/home1.gif'></IMG></A><br><br>");
%>
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
               <table>
                  ...
                  <table width="100%"  border="0" cellspacing="10" cellpadding="0">
                    <tr>
                      <td class="bodyheading"><!-- InstanceBeginEditable name="Heading" -->Hakkımızda<!-- InstanceEndEditable --></td>
                    </tr>
                    <tr>
                      <td class="bodytext"><!-- InstanceBeginEditable name="Body of Article" -->
                              <p align="center" class="bodytextheading"><img id="no-border" src="images/home1.gif" width="120" height="180"></img><br>
                                <span class="style2">HALK KÜTÜPHANESİ, c.p.</span></p>
                        <p align="justify" class="bodytextheading">Tarihçemiz</p>
                        <p align="justify">                                HALK KÜTÜPHANESİ c.p. is one of the most prestigious LIBRARYs in India. Founded as a Public LIBRARY in 1972 in New Delhi, it is a private institution run by the Delhi Public LIBRARY Society.</p>
                              <p align="justify"> HALK KÜTÜPHANESİ, c.p. is affiliated to the Central Board of LIBRARY (CBB), which is the largest educational board in the country. It is recognized by the Department of Education, Govt. of NCT Delhi and the Ministry of HRD, Govt. of India. Over 5000 LIBRARYs in India, with over 80,000 students, are members of the Board. </p>
                              ...
                              <p align="justify"> HALK KÜTÜPHANESİ, c.p. is a co-educational day-cum-boarding LIBRARY, with approximately 9,500 coustemer on its rolls. These children, in the Junior and Senior branches, study in the three different campuses at East of Kailash, Vasant Vihar and c.p.</p>
                              ...
                              <p align="justify"> To sum up, the mission of  HALK KÜTÜPHANESİ, c.p. &quot;to open doors and open minds&quot; and prepare the ground for the future of the nation.</p>
                              <p align="justify" class="bodytextheading"> Our Culture</p>
                              <p align="justify"> In the portals of  HALK KÜTÜPHANESİ, c.p., c.p. coustemer discover their own talents, and get an opportunity to develop them to the fullest. The LIBRARY provides an invigorating and competitive atmosphere, created by excellent facilities and guidance provided by a highly qualified and dedicated faculty.</p>
                              <p align="justify"> The values, which are ingrained help to promote confidence, direction, and critical thinking skills, leading to the development of well-adjusted, adaptable and integrated personalities. In other words,  HALK KÜTÜPHANESİ, c.p. offers comprehensive and holistic education.</p>
                              ...
                              <p align="justify"> These qualities have placed  HALK KÜTÜPHANESİ, c.p. on the forefront. There has been a continuity of purpose, underlying the change and growth of the LIBRARY. Over the years,  HALK KÜTÜPHANESİ, c.p. has steadily reflected a spirit of innovation in response to need, and has broadened its educational mission, by creating an academic environment that fosters close association and the exchange of ideas with some of the top LIBRARYs in the nation and the world.</p>
                              ...
                              <p align="justify"> All the academic programs and activities at  HALK KÜTÜPHANESİ, c.p. work towards one purpose - to help coustemer develop lives of significance for themselves and for others, true to the traditions of the LIBRARY Motto &quot;Service Before Self&quot;.</p>
  ...
  <table width="100%"  border="0" cellspacing="7" cellpadding="0">
        <tr>
          <td><div align="center"><span class="bottombar"><strong>&copy; HALK KÜTÜPHANESİ, c.p., Mozambik. All Rights Reserved. </strong></span></div></td>
        </tr>
        <tr> 
          <td>
